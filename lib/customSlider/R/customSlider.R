...
### original functions found at ### https://github.com/rstudio/shiny/blob/master/R/slider.R
...
# be wrapped in an "input" construct (e.g. customSliderInput in customSliderInput.R)
#
# this is a wrapper for: https://github.com/egorkhmelev/jslider
# (www/shared/slider contains js, css, and img dependencies)
customSlider <- function(inputId, min, max, value, step = NULL, ...,
